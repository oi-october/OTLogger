 ...
 * process is created.
 */
internal val appCtx: Context get() = internalCtx ?: initAndGetAppCtxWithReflection()
...
internal fun Context.injectAsAppCtx() {
 ...
 */
private fun Context.canLeakMemory(): Boolean = when (this) {
